...
/**
 * Driven Port (SPI) for notifying the core system (sbom-service) of state changes happening in an SBOM enhancement.
 * <p>
...
public interface StatusNotifier {
     ...
     * @param status       The new status (e.g., ENHANCING, FINISHED, FAILED).
